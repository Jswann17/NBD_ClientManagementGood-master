...
namespace NBD_ClientManagementGood.Models
{
    public class LabourUnit
    {
        public LabourUnit()
        {
            HeadStaffs = new HashSet<HeadStaff>();
        }
        ...
        public string LabourUnitTaskName { get; set; }
        ...
        public string LabourUnitTask { get; set; }
        ...
        public virtual ICollection<HeadStaff> HeadStaffs { get; set; }
    }
}
