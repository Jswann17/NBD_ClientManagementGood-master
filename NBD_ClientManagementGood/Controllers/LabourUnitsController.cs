...
namespace NBD_ClientManagementGood.Controllers
{
    public class LabourUnitsController : Controller
    {
        ...
        {
            var nBD_ClientManagementGoodContext = _context.LabourUnits.Include(l => l.LabourDepartment);
        ...
        {
            ViewData["LabourDepartmentID"] = new SelectList(_context.LabourDepartments, "ID", "DepartmentDescription");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,Hours,Cost,EstCost,TaskName,TaskDescription,LabourDepartmentID")] LabourUnit labourUnit)
        {
            ...
            ViewData["LabourDepartmentID"] = new SelectList(_context.LabourDepartments, "ID", "DepartmentDescription", labourUnit.LabourDepartmentID);
            return View(labourUnit);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,Hours,Cost,EstCost,TaskName,TaskDescription,LabourDepartmentID")] LabourUnit labourUnit)
        {
            if (id != labourUnit.ID)
            {
                return NotFound();
